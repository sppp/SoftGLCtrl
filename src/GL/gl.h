...
extern "C" {
	...
	typedef double			GLfloat;	/* single precision double */ /* also double for performance reasons */
...
void gl ## name ## 4dv(double *);
	...
	void glLoadMatrixf(const double *m);
	void glLoadIdentity(void);
	void glMultMatrixf(const double *m);
	...
	void glMaterialfv(int mode, int type, double *v);
	void glMaterialf(int mode, int type, double v);
	void glColorMaterial(int mode, int type);
	
	void glLightfv(int light, int type, double *v);
	void glLightf(int light, int type, double v);
	void glLightModeli(int pname, int param);
	void glLightModelfv(int pname, double *param);
	...
	void glGetFloatv(int pname, double *v);
	...
	inline void glFogfv(int, const double*) {}
	inline void glFogf(int, double) {}
	inline void glRasterPos2f(double, double) {}
