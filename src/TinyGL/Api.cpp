...
void glNormal3fv(double *v) {
	glNormal3f(v[0], v[1], v[2]);
}

/* glColor */

void glColor4f(double r, double g, double b, double a) {
	GLParam p[8];
...
void glColor3f(double x, double y, double z) {
//rev-color  glColor4f(z,y,x,1);

	glColor4f(x, y, z, 1);
}

void glColor3fv(double *v) {
