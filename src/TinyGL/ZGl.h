...
typedef struct GLSpecBuf {
	int shininess_i;
	int last_used;
	double buf[SPECULAR_BUFFER_SIZE+1];
...
/* matrix.c */
void gl_print_matrix(const double *m);
/*
...
static inline int gl_clipcode(double x, double y, double z, double w1) {
	double w;
